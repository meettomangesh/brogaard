 ...
 */
if (!class_exists('IndustrialistMikadoStickyNavigationWalker')) {
	class IndustrialistMikadoStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $angle_icon != "") {
					$item_output .= '<i class="mkd-menu-arrow fa '.$angle_icon.'"></i>';
				}
