<?php
class IndustrialistMikadoLike {

	private static $instance;

	private function __construct() {
		add_action('wp_enqueue_scripts', array( $this, 'enqueue_scripts'));
		add_action('wp_ajax_industrialist_mikado_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_industrialist_mikado_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'industrialist');
		if( isset($_COOKIE['mkd-like_'. $post->ID]) ){
			$class = 'mkd-like liked';
			$title = esc_html__('You already like this!', 'industrialist');
		}
...
if ( !function_exists( 'industrialist_mikado_create_like' ) ) {

    function industrialist_mikado_create_like() {
        IndustrialistMikadoLike::get_instance();
    }

    add_action('after_setup_theme', 'industrialist_mikado_create_like');
}