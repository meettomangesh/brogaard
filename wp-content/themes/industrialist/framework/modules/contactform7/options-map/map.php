...
if ( ! function_exists('industrialist_mikado_contact_form_7_options_map') ) {

	function industrialist_mikado_contact_form_7_options_map() {

		industrialist_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7','industrialist'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = industrialist_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1','industrialist'),
		));

		//Text Typography

		$typography_text_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography','industrialist'),
			'description'	=>esc_html__( 'Setup typography for form elements text','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color','industrialist'),
		));
		...
		$typography_text_row2 = industrialist_mikado_add_admin_row(array(
		...
		$typography_text_row3 = industrialist_mikado_add_admin_row(array(
		...
		$typography_label_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=>esc_html__( 'Form Label Typography','industrialist'),
			'description'	=> esc_html__('Setup typography for form elements label','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = industrialist_mikado_add_admin_row(array(
		...
		$typography_label_row2 = industrialist_mikado_add_admin_row(array(
		...
		$background_border_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border','industrialist'),
			'description'	=> esc_html__('Setup form elements background and border style','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color','industrialist')
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency','industrialist')
		));

		$background_border_row2 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=>esc_html__( 'Border Transparency','industrialist'),
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color','industrialist')
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency','industrialist')
		));

		$background_border_row3 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width','industrialist'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius','industrialist'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=>esc_html__( 'Elements Padding','industrialist'),
			'description'	=>esc_html__( 'Setup form elements padding','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = industrialist_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=>esc_html__( 'Padding Top','industrialist'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=>esc_html__( 'Padding Bottom','industrialist'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin','industrialist'),
			'description'	=> esc_html__('Setup form elements margin','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = industrialist_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=>esc_html__( 'Textarea Height','industrialist'),
			'description'	=> esc_html__('Enter height for textarea form element','industrialist'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=>esc_html__( 'Button Typography','industrialist'),
			'description'	=>esc_html__( 'Setup button text typography','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = industrialist_mikado_add_admin_row(array(
		...
		$button_typography_row2 = industrialist_mikado_add_admin_row(array(
		...
		$button_background_border_group = industrialist_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border','industrialist'),
			'description'	=>esc_html__( 'Setup button background and border style','industrialist'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency','industrialist')
		));

		$button_background_border_row2 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color','industrialist')
		));
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency','industrialist')
		));

		$button_background_border_row3 = industrialist_mikado_add_admin_row(array(
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height','industrialist'),
			'description'	=>esc_html__( 'Insert form button height','industrialist'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		industrialist_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=>esc_html__( 'Button Left/Right Padding','industrialist'),
			'description'	=>esc_html__( 'Enter value for button left and right padding','industrialist'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = industrialist_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2','industrialist')
		));
        ...
        $panel_contact_form_style_3 = industrialist_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3','industrialist'),
        ));
	...
	add_action( 'industrialist_mikado_options_map', 'industrialist_mikado_contact_form_7_options_map', 21);
