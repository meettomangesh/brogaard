 ...
 *
 * Class IndustrialistMikadoWidget
 */
abstract class IndustrialistMikadoWidget extends WP_Widget
{
    /**
    ...
    public function form($instance) {
        if (is_array($this->params) && count($this->params)) {
            ...
            if (isset($instance['title'])) {
                ...
                $title = esc_html__('New title', 'industrialist');
            }
    ...
    /*
     * render widget tile in widget interface
     *
     * @params string $widget_title
     */
    protected function widget_title($title) {

        echo '
        <p>
            <label for="' . esc_attr($this->get_field_id('title')) . '">' . esc_html__('Title:', 'industrialist') . '</label>
