...
class HeaderStandard extends HeaderType
{
    ...
    public function __construct() {
        ...
        if (!is_admin()) {
            ...
            $menuAreaHeight = industrialist_mikado_filter_px(industrialist_mikado_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function headerPerPageStyles($style) {
        ...
        $disable_grid_shadow = industrialist_mikado_get_meta_field_intersect('menu_area_in_grid_shadow_header_standard', $id) == 'no';
        $current_style = '';
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = industrialist_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard', $id) == 'yes' ? true : false;
        $parameters['menu_area_position'] = industrialist_mikado_get_meta_field_intersect('menu_area_position_header_standard', $id);
        ...
        $parameters = apply_filters('industrialist_mikado_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } elseif (industrialist_mikado_options()->getOptionValue('menu_area_background_color_header_standard') == '') {
            $menuAreaTransparent = industrialist_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
                industrialist_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') !== '1';
        } else {
            $menuAreaTransparent = industrialist_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                industrialist_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if (get_post_meta($id, 'mkd_menu_area_background_color_header_standard_meta', true) !== '') {
            ...
            $menuAreaTransparent = industrialist_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
                industrialist_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') === '0';
        } else {
            $menuAreaTransparent = industrialist_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                industrialist_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
        }
