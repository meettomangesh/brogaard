...
<header class="mkd-page-header">
    <div class="mkd-logo-area <?php echo esc_attr($logo_area_style) ?>">
        <?php if($logo_area_in_grid) : ?>
        <div class="mkd-grid">
        <?php endif; ?>
			<?php do_action( 'industrialist_mikado_after_header_logo_area_html_open' )?>
    ...
    <div class="mkd-menu-area">
        ...
        <?php endif; ?>
            ...
            <div class="mkd-vertical-align-containers">
                <div class="mkd-position-left">
                    <div class="mkd-position-left-inner">
                        <?php industrialist_mikado_get_main_menu(); ?>
                    </div>
                </div>
                <div class="mkd-position-right">
                    <div class="mkd-position-right-inner">
    ...
    <?php endif; ?>
    <?php if($show_sticky) {
        industrialist_mikado_get_sticky_header();
    } ?>
</header>
