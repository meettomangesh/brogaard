<?php if($show_header_top) : ?>
	...
	<?php do_action('industrialist_mikado_before_header_top'); ?>
	...
	<div class="mkd-top-bar">
		...
		<div class="mkd-grid">
			<?php endif; ?>
			<?php do_action('industrialist_mikado_after_header_top_html_open'); ?>
			<div class="mkd-vertical-align-containers <?php echo esc_attr($column_widths); ?>">
				<div class="mkd-position-left mkd-top-bar-widget-area">
                    <?php if ($header_box_logo_area) { /* this is only present for header in box mode */ ?>
                        <div class="mkd-position-left-inner <?php echo esc_attr($logo_area_style) ?>">
                            <?php industrialist_mikado_get_logo(); ?>
                        </div>
                    <?php } else { ?>
	...
	<?php do_action('industrialist_mikado_after_header_top'); ?>
