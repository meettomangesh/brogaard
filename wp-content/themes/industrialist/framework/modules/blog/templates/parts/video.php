...
if ( $video_type == 'social_networks' ) {
	...
	<div class="mkd-self-hosted-video-holder">
		<div class="mkd-mobile-video-image"
		     style="background-image: url(<?php echo esc_url( $meta_temp_image = get_post_meta( get_the_ID(), "mkd_post_video_image_meta", true ) ); ?>);"></div>
		<div class="mkd-video-wrap">
			<video class="mkd-self-hosted-video"
				...
				<object width="320" height="240" type="application/x-shockwave-flash"
					...
					<img itemprop="image" src="<?php echo esc_url( $meta_temp_image ); ?>" width="1920" height="800"
					     ...
					     alt="<?php esc_html_e( 'video thumb', 'industrialist' ); ?>"/>
				</object>
			</video>
		</div>
	</div>
