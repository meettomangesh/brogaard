<?php
namespace Industrialist\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface
{
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name' => esc_html__('Custom Font', 'industrialist'),
            'base' => $this->getBase(),
            ...
            'params' => array(
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Custom Font Tag', 'industrialist'),
                ...
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Font family', 'industrialist'),
                ...
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Line height (px)', 'industrialist'),
                    'param_name' => 'line_height',
                    'value' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Font Style', 'industrialist'),
                    'param_name' => 'font_style',
                    'value' => industrialist_mikado_get_font_style_array(),
                    'description' => ''
                ),
                array(
                    'type' => 'dropdown',
                    ...
                    'value' => industrialist_mikado_get_font_weight_array(),
                    'save_always' => true
                ),
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Letter Spacing (px)', 'industrialist'),
                    'param_name' => 'letter_spacing',
                    'value' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Text transform', 'industrialist'),
                    'param_name' => 'text_transform',
                    'value' => industrialist_mikado_get_text_transform_array(),
                    'description' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Text decoration', 'industrialist'),
                    'param_name' => 'text_decoration',
                    'value' => array(
                        esc_html__('None', 'industrialist') => '',
                        esc_html__('Underline', 'industrialist') => 'underline',
                        esc_html__('Overline', 'industrialist') => 'overline',
                        esc_html__('Line Through', 'industrialist') => 'line-through'
                    ),
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Text Align', 'industrialist'),
                    ...
                    'value' => array(
                        ...
                        esc_html__('Justify', 'industrialist') => 'justify'
                    ),
                    'description' => ''
                ),
                array(
                    ...
                    'value' => esc_html__('Custom Font Content','industrialist'),
                    'description' => '',
                    'save_always' => true
                )
            )
    ...
    public function render($atts, $content = null) {
        ...
        $html = industrialist_mikado_get_shortcode_module_template_part('templates/custom-font', 'custom-font', '', $params);
