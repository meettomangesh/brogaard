<?php
namespace Industrialist\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface
{
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name' => esc_html__('Blockquote', 'industrialist'),
            'base' => $this->getBase(),
            ...
            'params' => array(
                array(
                    ...
                    'param_name' => 'text',
                    'value' => esc_html__('Blockquote text','industrialist'),
                    'save_always' => true
                ),
                array(
                    'type' => 'dropdown',
    ...
    public function render($atts, $content = null) {
        ...
        $html = industrialist_mikado_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
