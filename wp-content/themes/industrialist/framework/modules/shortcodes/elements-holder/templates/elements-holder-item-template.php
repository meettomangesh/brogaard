<div class="mkd-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo industrialist_mikado_get_inline_attrs($elements_holder_item_data); ?> <?php echo industrialist_mikado_get_inline_style($elements_holder_item_style); ?>>
	<div class="mkd-elements-holder-item-inner">
		<div class="mkd-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo industrialist_mikado_get_inline_style($elements_holder_item_content_style); ?>>
			...
			<style type="text/css" data-type="mkd-elements-custom-padding" scoped>
                ...
                @media only screen and (min-width: 1280px) and (max-width: 1600px) {
                    .mkd-elements-holder-item-content.<?php echo esc_attr($elements_holder_item_content_class); ?> {
