<?php
namespace Industrialist\Modules\Shortcodes\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface
{
    ...
    public function vcMap() {
        if (function_exists('vc_map')) {
            vc_map(
                array(
                    'name' => esc_html__('Elements Holder Item', 'industrialist'),
                    'base' => $this->base,
                    ...
                    'params' => array(
                        ...
                        array(
                            'type' => 'textfield',
                            'class' => '',
                            'heading' => esc_html__('Padding', 'industrialist'),
                            'param_name' => 'item_padding',
                            'value' => '',
                            'description' => esc_html__('Please insert padding in format 0px 10px 0px 10px', 'industrialist')
                        ),
                        array(
                            'type' => 'dropdown',
                            'class' => '',
                            'heading' => esc_html__('Horizontal Alignment', 'industrialist'),
                        ...
                        array(
                            'type' => 'dropdown',
                            'class' => '',
                            'heading' => esc_html__('Vertical Alignment', 'industrialist'),
                            'param_name' => 'vertical_alignment',
                            'value' => array(
                                esc_html__('Middle', 'industrialist') => 'middle',
                        ...
                        array(
                            'type' => 'dropdown',
                            'class' => '',
                            'heading' => esc_html__('Animation Name', 'industrialist'),
                            'param_name' => 'animation_name',
                            'value' => array(
                                esc_html__('No Animation', 'industrialist') => '',
                                esc_html__('Flip In', 'industrialist') => 'flip-in',
                                esc_html__('Grow In', 'industrialist') => 'grow-in',
                                esc_html__('X Rotate', 'industrialist') => 'x-rotate',
                                esc_html__('Z Rotate', 'industrialist') => 'z-rotate',
                                esc_html__('Y Translate', 'industrialist') => 'y-translate',
                                esc_html__('Fade In', 'industrialist') => 'fade-in',
                                esc_html__('Fade In Down', 'industrialist') => 'fade-in-down',
                                esc_html__('Fade In Left X Rotate', 'industrialist') => 'fade-in-left-x-rotate'
                            ),
                            'description' => ''
                        ),
                        array(
                            'type' => 'textfield',
                            'class' => '',
                            'heading' => esc_html__('Animation Delay (ms)', 'industrialist'),
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Padding on screen size between 1280px-1600px', 'industrialist'),
                        ...
                        array(
                            ...
                            'class' => '',
                            'group' => esc_html__('Width & Responsiveness', 'industrialist'),
                            'heading' => esc_html__('Padding on screen size between 1024px-1280px', 'industrialist'),
                        ...
                        array(
                            ...
                            'class' => '',
                            'group' => esc_html__('Width & Responsiveness', 'industrialist'),
                            'heading' => esc_html__('Padding on screen size between 768px-1024px', 'industrialist'),
                        ...
                        array(
                            ...
                            'class' => '',
                            'group' => esc_html__('Width & Responsiveness', 'industrialist'),
                            'heading' => esc_html__('Padding on screen size between 600px-768px', 'industrialist'),
                        ...
                        array(
                            ...
                            'class' => '',
                            'group' => esc_html__('Width & Responsiveness', 'industrialist'),
                            'heading' => esc_html__('Padding on screen size between 480px-600px', 'industrialist'),
                        ...
                        array(
                            ...
                            'class' => '',
                            'group' => esc_html__('Width & Responsiveness', 'industrialist'),
                            'heading' => esc_html__('Padding on Screen Size Bellow 480px', 'industrialist'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = industrialist_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
