...
/*
   Class: IndustrialistMikadoFramework
...
class IndustrialistMikadoFramework
{
    ...
    private function __construct() {
        $this->mkdOptions = IndustrialistMikadoOptions::get_instance();
        $this->mkdMetaBoxes = IndustrialistMikadoMetaBoxes::get_instance();
    }
    ...
    public function setSkin(IndustrialistMikadoSkinAbstract $skinObject) {
        $this->skin = $skinObject;
    }
}

/**
 * Class IndustrialistMikadoSkinManager
 *
...
/**
 * Class IndustrialistMikadoSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class IndustrialistMikadoSkinAbstract
{
    /**
     * @var string
     */
    ...
    public function loadTemplatePart($template, $params = array()) {
        ...
        if ($template !== '') {
            include(industrialist_mikado_find_template_path('framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php'));
        }
    }
    ...
    public function setShortcodeJSParams() { ?>
        <script>
            window.mkdSCIcon = '<?php echo industrialist_mikado_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: IndustrialistMikadoOptions
...
class IndustrialistMikadoOptions
{
    ...
    public function getOptionValue($key) {
        ...
        if (array_key_exists($key, $industrialist_options)) {
            return $industrialist_options[$key];
...
/*
   Class: IndustrialistMikadoAdminPage
   A class that initializes Mikado Admin Page
*/

class IndustrialistMikadoAdminPage implements iIndustrialistMikadoLayoutNode
{
    ...
    function __construct($slug = "", $title = "", $icon = "") {
        $this->layout = array();
        $this->factory = new IndustrialistMikadoFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
    ...
    public function renderChild(iIndustrialistMikadoRender $child) {
        $child->render($this->factory);
    }
}

/*
   Class: IndustrialistMikadoMetaBoxes
...
/*
   Class: IndustrialistMikadoMetaBox
   A class that initializes Mikado Meta Box
*/

class IndustrialistMikadoMetaBox implements iIndustrialistMikadoLayoutNode
{
    ...
    public function setTitle($label) {
        ...
        return $industrialist_Framework->getSkin()->getSkinLabel() . ' ' . $label;
    }
}

if (!function_exists('industrialist_mikado_init_framework_variable')) {

    function industrialist_mikado_init_framework_variable() {

        global $industrialist_Framework;

        $industrialist_Framework = IndustrialistMikadoFramework::get_instance();
        $mkdSkinManager = new IndustrialistMikadoSkinManager();
        $industrialist_Framework->setSkin($mkdSkinManager->getSkin());
    }

    add_action('industrialist_mikado_before_options_map', 'industrialist_mikado_init_framework_variable');
}
?>