...
/*
  Class: IndustrialistMikadoIconCollections
...
class IndustrialistMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new IndustrialistMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new IndustrialistMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new IndustrialistMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new IndustrialistMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new IndustrialistMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new IndustrialistMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iIndustrialistMikadoIconCollection $collection) {
...
if ( ! function_exists( 'industrialist_mikado_activate_theme_icons' ) ) {

    function industrialist_mikado_activate_theme_icons() {
        global $industrialist_IconCollections;
        $industrialist_IconCollections = IndustrialistMikadoIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'industrialist_mikado_activate_theme_icons');
}