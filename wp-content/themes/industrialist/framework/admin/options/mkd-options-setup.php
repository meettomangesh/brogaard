...
add_action('after_setup_theme', 'industrialist_mikado_admin_map_init', 0);

function industrialist_mikado_admin_map_init() {

    do_action('industrialist_mikado_before_options_map');
    ...
    do_action('industrialist_mikado_options_map');

    do_action('industrialist_mikado_after_options_map');
