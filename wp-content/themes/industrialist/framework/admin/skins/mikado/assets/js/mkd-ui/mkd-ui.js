(function ($) {
    ...
    function mkdChangedInput() {
        ...
        $('.mkd-tabs-content form.mkd_ajax_form:not(.mkd-import-page-holder) #anchornav input').click(function () {
            ...
            setTimeout(function () {
                $('.mkd-changes-saved').removeClass('yes');
            }, 3000);
        });
    }
            ...
            frame: function () {
                ...
                this._frame.on('update', function () {
                    ...
                    jQuery.ajax({
                        type: "post",
                        url: ajaxurl,
                        data: "action=industrialist_mikado_gallery_upload_get_images&ids=" + ids,
    ...
    function mkdInitAjaxForm() {
        ...
        $(document).delegate(".mkd_ajax_form", "submit", function (a) {
            var b = $(this);
            var c = {
                action: "industrialist_mikado_save_options"
            };
            jQuery.ajax({
                url: ajaxurl,
                cache: !1,
