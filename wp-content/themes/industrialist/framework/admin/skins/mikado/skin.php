...
class MikadoSkin extends IndustrialistMikadoSkinAbstract
{
    /**
     * Skin constructor. Hooks to industrialist_mikado_admin_scripts_init and industrialist_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('industrialist_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('industrialist_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('industrialist_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('industrialist_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('industrialist_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('industrialist_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            industrialist_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            industrialist_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function setIcons() {
        $icons_array = array(
            ...
            'clients' => $this->getSkinURI() . '/assets/img/admin-logo-icon.png',
            'options' => 'dashicons-admin-generic'
        );
        $icons_array = apply_filters('industrialist_mikado_set_skin_icons', $icons_array, $this->getSkinURI() . '/');
    ...
    public function setMenuItemPosition() {
        ...
        $positions_array = apply_filters('industrialist_mikado_set_skin_menu_positions', $positions_array);
    ...
    public function renderOptions() {
        ...
        $tab = industrialist_mikado_get_admin_tab();
        $active_page = $industrialist_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @param IndustrialistMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(industrialist_mikado_get_theme_info_item('Name'), industrialist_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
