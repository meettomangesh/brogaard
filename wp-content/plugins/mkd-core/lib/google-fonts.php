<?php
if ( ! function_exists( 'industrialist_mikado_init_google_fonts_array' ) ) {
    function industrialist_mikado_init_google_fonts_array() {

        global $industrialist_fonts_array;
        $industrialist_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'industrialist_mikado_init_google_fonts_array');
}